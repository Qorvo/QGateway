 ...
 *
 * $Header: //depot/release/Embedded/Components/Qorvo/802_15_4/v2.10.3.1/comps/gpRxArbiter/src/gen/gpRxArbiter_wrapper_client.c#1 $
 * $Change: 197210 $
...
#define commandId                                           dataBuf[0]
    ...
    commandId = gpRxArbiter_SetDutyCycleOnOffTimes_CmdId;

    gpRxArbiter_SetDutyCycleOnOffTimes_Input_par2buf(dataBuf
        , onTimeUs
        , offTimeUs
        , stackId
        , &_index);
    ...
    GP_ASSERT_SYSTEM(gpMarshall_AckStatusSuccess == gpRxArbiter_ackBuffer[1]);
    GP_ASSERT_SYSTEM(gpRxArbiter_SetDutyCycleOnOffTimes_CmdId == gpRxArbiter_ackBuffer[2]);

    _index = 3;
    gpRxArbiter_SetDutyCycleOnOffTimes_Output_buf2par(
          &result
        , onTimeUs
        , offTimeUs
        , stackId
...
#define commandId                                           dataBuf[0]
    ...
    commandId = gpRxArbiter_EnableDutyCycling_CmdId;

    gpRxArbiter_EnableDutyCycling_Input_par2buf(dataBuf
        , enable
        , stackId
        , &_index);
    ...
    GP_ASSERT_SYSTEM(gpMarshall_AckStatusSuccess == gpRxArbiter_ackBuffer[1]);
    GP_ASSERT_SYSTEM(gpRxArbiter_EnableDutyCycling_CmdId == gpRxArbiter_ackBuffer[2]);
...
gpRxArbiter_Result_t gpRxArbiter_EnableRxWindows(UInt8 channel, UInt32 dutyCycleOnTime, UInt32 dutyCyclePeriod, UInt16 recurrenceAmount, UInt32 startTime, gpRxArbiter_StackId_t stackId)
{
    UInt16 _index = 1;
    gpRxArbiter_Result_t result;
    UInt8 dataBuf[1 + 1 + 4*1 + 4*1 + 2*1 + 4*1 + 1];
...
#define commandId                                           dataBuf[0]
    ...
    commandId = gpRxArbiter_EnableRxWindows_CmdId;

    gpRxArbiter_EnableRxWindows_Input_par2buf(dataBuf
        , channel
        , dutyCycleOnTime
        , dutyCyclePeriod
        , recurrenceAmount
    ...
    GP_ASSERT_SYSTEM(gpMarshall_AckStatusSuccess == gpRxArbiter_ackBuffer[1]);
    GP_ASSERT_SYSTEM(gpRxArbiter_EnableRxWindows_CmdId == gpRxArbiter_ackBuffer[2]);

    _index = 3;
    gpRxArbiter_EnableRxWindows_Output_buf2par(
          &result
        , channel
        , dutyCycleOnTime
        , dutyCyclePeriod
...
#define commandId                                           dataBuf[0]
    ...
    commandId = gpRxArbiter_DisableRxWindows_CmdId;

    gpRxArbiter_DisableRxWindows_Input_par2buf(dataBuf
        , stackId
        , &_index);
    ...
    GP_ASSERT_SYSTEM(gpMarshall_AckStatusSuccess == gpRxArbiter_ackBuffer[1]);
    GP_ASSERT_SYSTEM(gpRxArbiter_DisableRxWindows_CmdId == gpRxArbiter_ackBuffer[2]);
