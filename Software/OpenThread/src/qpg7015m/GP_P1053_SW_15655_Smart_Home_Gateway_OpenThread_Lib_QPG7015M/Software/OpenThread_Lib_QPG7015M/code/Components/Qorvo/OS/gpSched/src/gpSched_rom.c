 ...
 *
 * $Header: //depot/release/Embedded/Components/Qorvo/OS/v2.10.3.1/comps/gpSched/src/gpSched_rom.c#1 $
 * $Change: 197210 $
...
void Sched_RescheduleEvent (UInt32 rel_time, gpSched_Event_t * pevt)
{
    ...
    if(pList->plnk_first)
    {
        ...
        // equal mean max time event already exist
...
{
    gpSched_globals_t* sched_globals;
...
#endif
    sched_globals = GP_SCHED_GET_GLOBALS();
