 ...
 *
 * $Header: //depot/release/Embedded/Components/Qorvo/BaseUtils/v2.10.2.0/comps/gpCom/src/gpCom_defs.h#1 $
 * $Change: 187624 $
...
#include "gpCom.h"
#ifdef GP_COM_DIVERSITY_IOCTL
#include "linux/ioctl.h"
#endif //def GP_COM_DIVERSITY_IOCTL
/****************************************************************************
 *                    Macro Definitions
 *****************************************************************************/
...
#define GP_IOCTL_WRITE_MSG _IOW(GP_IOC_MAGIC, 1, int)
#define GP_IOCTL_READ_MSG  _IOR(GP_IOC_MAGIC, 2, int)
#define GP_IOCTL_WRITE_STREAM_MSG _IOW(GP_IOC_MAGIC, 3, int)
#define GP_IOCTL_READ_STREAM_MSG  _IOR(GP_IOC_MAGIC, 4, int)
#endif //def GP_COM_DIVERSITY_IOCTL
...
#ifdef GP_COM_DIVERSITY_IOCTL
typedef struct gpComIoctl_Buffer_s {
    /* WARNING: do not change this struct.  It is a binary interface between
     * kernel- and usercode */
    UInt8  moduleID;
    UInt16 length;
    gpCom_CommunicationId_t commId;
...
#if defined(GP_COM_DIVERSITY_IOCTL) 
#define Com_FlushRxIoctl() ComIoctl_FlushRx();
#else
...
#ifdef GP_COM_DIVERSITY_IOCTL
extern void gpComIoctl_Init(void);
extern Bool gpComIoctl_DataRequest(UInt8 moduleID, UInt16 length, UInt8* pData, gpCom_CommunicationId_t commId);
extern Bool gpComIoctl_GetTXEnable(void);
extern void gpComIoctl_HandleTx(void);
extern void gpComIoctl_Flush(void);
extern void ComIoctl_FlushRx(void);
extern void gpComIoctl_DeInit(void);
extern Bool gpComIoctl_TXDataPending(void);
#endif //GP_COM_DIVERSITY_IOCTL
