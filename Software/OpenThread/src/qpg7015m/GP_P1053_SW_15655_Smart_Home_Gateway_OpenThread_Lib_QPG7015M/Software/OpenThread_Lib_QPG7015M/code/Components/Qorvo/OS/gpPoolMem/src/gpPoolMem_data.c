 ...
 *
 * $Header: //depot/release/Embedded/Components/Qorvo/OS/v2.10.2.0/comps/gpPoolMem/src/gpPoolMem_data.c#1 $
 * $Change: 187624 $
...
gpPoolMem_Chunkpd_t Chunkpd[GP_POOLMEM_PD_AMOUNT] GP_EXTRAM_SECTION_ATTR;
