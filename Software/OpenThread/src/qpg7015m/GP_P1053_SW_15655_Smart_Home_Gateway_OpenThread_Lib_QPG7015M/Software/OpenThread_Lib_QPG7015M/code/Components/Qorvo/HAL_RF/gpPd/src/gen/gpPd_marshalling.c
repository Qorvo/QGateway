 ...
 *
 * $Header: //depot/release/Embedded/Components/Qorvo/HAL_RF/v2.10.2.3/comps/gpPd/src/gen/gpPd_marshalling.c#1 $
 * $Change: 190959 $
...
#endif
            gpPd_FreeRealPd(pDest->handle);/* Failure to associate client and server side handles causes freeing of server side handle... */
