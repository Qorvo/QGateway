 ...
 *
 * $Header: //depot/release/Embedded/Components/Qorvo/HAL_RF/v2.10.2.0/comps/gpPd/inc/gpPd.h#1 $
 * $Change: 187624 $
...
#if   defined (GP_DIVERSITY_PD_USE_RAM_VARIANT)
#ifndef GP_PD_NR_OF_HANDLES
#ifdef GPHAL_NUMBER_OF_PBMS_USED
#define GP_PD_NR_OF_HANDLES         GPHAL_NUMBER_OF_PBMS_USED
#else
#define GP_PD_NR_OF_HANDLES         5
#endif //GPHAL_NUMBER_OF_PBMS_USED
