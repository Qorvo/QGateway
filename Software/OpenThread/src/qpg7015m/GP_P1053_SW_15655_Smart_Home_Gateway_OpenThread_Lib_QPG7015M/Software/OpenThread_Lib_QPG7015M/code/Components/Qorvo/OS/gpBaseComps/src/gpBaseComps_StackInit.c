 ...
 *
 * $Header: //depot/release/Embedded/Components/Qorvo/OS/v2.10.2.0/comps/gpBaseComps/src/gpBaseComps_StackInit.c#1 $
 * $Change: 187624 $
...
#if defined(GP_VERSION_DIVERSITY_GPCOM_CLIENT) && !defined(GP_VERSION_DIVERSITY_NO_MODULE_VERSION) && !defined(GP_COMP_UNIT_TEST)
    if (gpVersion_ExchangeCompatibility() != gpVersion_CompatibilityResultCompatible)
    {
