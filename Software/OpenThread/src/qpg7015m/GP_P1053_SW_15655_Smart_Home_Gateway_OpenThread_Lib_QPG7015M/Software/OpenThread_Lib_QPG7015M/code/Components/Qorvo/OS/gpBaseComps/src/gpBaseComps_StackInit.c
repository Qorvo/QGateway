 ...
 *
 * $Header: //depot/release/Embedded/Components/Qorvo/OS/v2.10.3.1/comps/gpBaseComps/src/gpBaseComps_StackInit.c#1 $
 * $Change: 197210 $
...
#if !defined(GP_VERSION_DIVERSITY_NO_MODULE_VERSION) && !defined(GP_COMP_UNIT_TEST)
