...
#define commandId                                           dataBuf[0]
    ...
    commandId = gpMacDispatcher_ScheduleTimedTx_CmdId;

    gpMacDispatcher_ScheduleTimedTx_Input_par2buf(dataBuf
        , pdHandle
        , timingOptions
        , stackId
        , &_index);
    ...
    GP_ASSERT_SYSTEM(gpMarshall_AckStatusSuccess == gpMacDispatcher_ackBuffer[1]);
    GP_ASSERT_SYSTEM(gpMacDispatcher_ScheduleTimedTx_CmdId == gpMacDispatcher_ackBuffer[2]);
...
{
    UInt16 _index = 1;
    UInt8 dataBuf[1 + 4*1 + 4*1 + 2*1 + 4*1 + 1];
...
#define commandId                                           dataBuf[0]
    ...
    commandId = gpMacDispatcher_EnableRxWindows_CmdId;

    gpMacDispatcher_EnableRxWindows_Input_par2buf(dataBuf
        , dutyCycleOnTime
        , dutyCyclePeriod
        , recurrenceAmount
        , startTime
    ...
    GP_ASSERT_SYSTEM(gpMarshall_AckStatusSuccess == gpMacDispatcher_ackBuffer[1]);
    GP_ASSERT_SYSTEM(gpMacDispatcher_EnableRxWindows_CmdId == gpMacDispatcher_ackBuffer[2]);
...
#define commandId                                           dataBuf[0]
    ...
    commandId = gpMacDispatcher_DisableRxWindows_CmdId;

    gpMacDispatcher_DisableRxWindows_Input_par2buf(dataBuf
        , stackId
        , &_index);
    ...
    GP_ASSERT_SYSTEM(gpMarshall_AckStatusSuccess == gpMacDispatcher_ackBuffer[1]);
    GP_ASSERT_SYSTEM(gpMacDispatcher_DisableRxWindows_CmdId == gpMacDispatcher_ackBuffer[2]);
...
#define commandId                                           dataBuf[0]
    ...
    commandId = gpMacDispatcher_EnableCsl_CmdId;

    gpMacDispatcher_EnableCsl_Input_par2buf(dataBuf
        , dutyCyclePeriod
        , stackId
        , &_index);
    ...
    GP_ASSERT_SYSTEM(gpMarshall_AckStatusSuccess == gpMacDispatcher_ackBuffer[1]);
    GP_ASSERT_SYSTEM(gpMacDispatcher_EnableCsl_CmdId == gpMacDispatcher_ackBuffer[2]);
...
#define commandId                                           dataBuf[0]
    ...
    commandId = gpMacDispatcher_UpdateCslSampleTime_CmdId;

    gpMacDispatcher_UpdateCslSampleTime_Input_par2buf(dataBuf
        , nextCslSampleTime
        , stackId
        , &_index);
    ...
    GP_ASSERT_SYSTEM(gpMarshall_AckStatusSuccess == gpMacDispatcher_ackBuffer[1]);
    GP_ASSERT_SYSTEM(gpMacDispatcher_UpdateCslSampleTime_CmdId == gpMacDispatcher_ackBuffer[2]);
...
#define commandId                                           dataBuf[0]
    ...
    commandId = gpMacDispatcher_GetCurrentTimeUs_CmdId;

    GP_ASSERT_SYSTEM(_index <= sizeof(dataBuf));
    DATA_REQUEST_ACKED(_index, dataBuf, GP_MACDISPATCHER_COMM_ID);

    GP_ASSERT_SYSTEM(gpMarshall_AckStatusSuccess == gpMacDispatcher_ackBuffer[1]);
    GP_ASSERT_SYSTEM(gpMacDispatcher_GetCurrentTimeUs_CmdId == gpMacDispatcher_ackBuffer[2]);
