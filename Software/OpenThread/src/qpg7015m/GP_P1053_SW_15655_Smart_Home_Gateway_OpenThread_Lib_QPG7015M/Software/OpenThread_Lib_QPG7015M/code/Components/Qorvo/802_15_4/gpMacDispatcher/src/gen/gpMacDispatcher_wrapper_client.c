 ...
 *
 * $Header: //depot/release/Embedded/Components/Qorvo/802_15_4/v2.10.2.0/comps/gpMacDispatcher/src/gen/gpMacDispatcher_wrapper_client.c#1 $
 * $Change: 187624 $
...
#if defined(GP_VERSION_DIVERSITY_GPCOM_CLIENT) && !defined(GP_VERSION_DIVERSITY_NO_MODULE_VERSION)
    gpVersion_ReleaseInfo_t versions[1] = {{2,1,0,0}};
