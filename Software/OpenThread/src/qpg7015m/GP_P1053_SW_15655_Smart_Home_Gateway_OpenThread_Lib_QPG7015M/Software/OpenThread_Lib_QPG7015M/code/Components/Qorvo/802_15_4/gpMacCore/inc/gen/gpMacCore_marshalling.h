 ...
 *
 * $Header: //depot/release/Embedded/Components/Qorvo/802_15_4/v2.10.3.1/comps/gpMacCore/inc/gen/gpMacCore_marshalling.h#1 $
 * $Change: 197210 $
...
typedef struct {
    gpMacCore_StackId_t stackId;
} gpMacCore_GetCurrentTimeUs_Input_struct_t;

typedef struct {
    gpMacCore_GetCurrentTimeUs_Input_struct_t data;
} gpMacCore_GetCurrentTimeUs_Input_marshall_struct_t;
...
typedef union {
    ...
    gpMacCore_GetCurrentTimeUs_Input_marshall_struct_t gpMacCore_GetCurrentTimeUs;
...
gpMarshall_AckStatus_t gpMacCore_GetCurrentTimeUs_Input_buf2api(gpMacCore_GetCurrentTimeUs_Input_marshall_struct_t* pDest , UInt8Buffer* pSource , UInt16* pIndex);
void gpMacCore_GetCurrentTimeUs_Output_api2buf(UInt8Buffer* pDest , gpMacCore_GetCurrentTimeUs_Output_marshall_struct_t* pSourceoutput , gpMacCore_GetCurrentTimeUs_Input_marshall_struct_t* pSourceinput , UInt16* pIndex);
...
void gpMacCore_GetCurrentTimeUs_Input_par2buf(UInt8Buffer* pDest , gpMacCore_StackId_t stackId , UInt16* pIndex);
void gpMacCore_GetCurrentTimeUs_Output_buf2par(UInt32* currentTime , gpMacCore_StackId_t stackId , UInt8Buffer* pSource , UInt16* pIndex);
