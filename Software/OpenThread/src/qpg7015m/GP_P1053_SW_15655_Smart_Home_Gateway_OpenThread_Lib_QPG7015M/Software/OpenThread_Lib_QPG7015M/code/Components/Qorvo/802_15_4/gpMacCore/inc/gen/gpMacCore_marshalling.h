 ...
 *
 * $Header: //depot/release/Embedded/Components/Qorvo/802_15_4/v2.10.2.0/comps/gpMacCore/inc/gen/gpMacCore_marshalling.h#1 $
 * $Change: 187624 $
...
#if defined(GP_MACCORE_DIVERSITY_ADDRESSMODEOVERRIDEFORBEACONS)
typedef struct {
    UInt8 addressMode;
    gpMacCore_StackId_t stackId;
...
#endif /* defined(GP_MACCORE_DIVERSITY_ADDRESSMODEOVERRIDEFORBEACONS) */
...
#if defined(GP_MACCORE_DIVERSITY_SECURITY_ENABLED)
void gpMacCore_GetFrameCounter_Output_api2buf(UInt8Buffer* pDest , gpMacCore_GetFrameCounter_Output_marshall_struct_t* pSourceoutput , UInt16* pIndex);
#endif /* defined(GP_MACCORE_DIVERSITY_SECURITY_ENABLED) */
...
#if defined(GP_MACCORE_DIVERSITY_SECURITY_ENABLED)
void gpMacCore_SetFrameCounter_Input_par2buf(UInt8Buffer* pDest , UInt32 frameCounter , UInt16* pIndex);
#endif /* defined(GP_MACCORE_DIVERSITY_SECURITY_ENABLED) */
...
#if defined(GP_MACCORE_DIVERSITY_SECURITY_ENABLED)
void gpMacCore_GetFrameCounter_Output_buf2par(UInt32* frameCounter , UInt8Buffer* pSource , UInt16* pIndex);
#endif /* defined(GP_MACCORE_DIVERSITY_SECURITY_ENABLED) */
