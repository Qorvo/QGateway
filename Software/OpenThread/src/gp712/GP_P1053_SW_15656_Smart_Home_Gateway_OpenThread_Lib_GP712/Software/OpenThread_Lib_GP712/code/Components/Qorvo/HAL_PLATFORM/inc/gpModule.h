 ...
 *
 * $Header: //depot/release/Embedded/Components/Qorvo/HAL_PLATFORM/v2.10.3.1/inc/gpModule.h#1 $
 * $Change: 197210 $
...
#endif // GP_COMP_NVM
#if defined(GP_NVM_RW_CACHE_DIVERSITY_GPCOM_SERVER) || defined(GP_NVM_RW_CACHE_DIVERSITY_GPCOM_CLIENT)
#define GP_MODULE_ID_NVM_RW_CACHEAPI            111
#endif //defined(GP_NVM_RW_CACHE_DIVERSITY_GPCOM_SERVER) || defined(GP_NVM_RW_CACHE_DIVERSITY_GPCOM_CLIENT)
#ifdef GP_COMP_RESET
