 ...
 *
 * $Header: //depot/release/Embedded/Components/Qorvo/OS/v2.10.2.2/comps/gpPoolMem/src/gpPoolMem_defs.h#1 $
 * $Change: 190959 $
...
#ifdef GP_POOLMEM_PD_AMOUNT
#define GP_POOLMEM_MAX_ENTRIES (GP_POOLMEM_PD_AMOUNT + GP_POOLMEM_CHUNK_AMOUNT1 + GP_POOLMEM_CHUNK_AMOUNT2 + GP_POOLMEM_CHUNK_AMOUNT3)
#else
#define GP_POOLMEM_MAX_ENTRIES (GP_POOLMEM_CHUNK_AMOUNT1 + GP_POOLMEM_CHUNK_AMOUNT2 + GP_POOLMEM_CHUNK_AMOUNT3)
#endif // GP_POOLMEM_PD_AMOUNT
