 ...
 *
 * $Header: //depot/release/Embedded/Components/Qorvo/BaseUtils/v2.10.2.0/comps/gpEncryption/src/gen/gpEncryption_marshalling.c#1 $
 * $Change: 187624 $
...
#endif
            gpPd_FreeRealPd(pDest->pdHandle);/* Failure to associate client and server side handles causes freeing of server side handle... */
            return gpMarshall_AckStatusExecutionFailed;/* ...and causes server to indicate failure in acknowledge to client. */
        }
        *pIndex += 1;
