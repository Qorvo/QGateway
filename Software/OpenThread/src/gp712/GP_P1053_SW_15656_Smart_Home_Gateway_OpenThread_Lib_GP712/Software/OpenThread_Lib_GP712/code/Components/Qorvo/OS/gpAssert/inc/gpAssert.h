 ...
 *
 * $Header: //depot/release/Embedded/Components/Qorvo/OS/v2.10.2.0/comps/gpAssert/inc/gpAssert.h#1 $
 * $Change: 187624 $
...
#define GP_DIVERSITY_GLOBAL_ASSERT_LEVEL GP_DIVERSITY_ASSERT_LEVEL_DEV_INT
