 ...
 *
 * $Header: //depot/release/Embedded/Components/Qorvo/OS/v2.10.2.0/comps/gpVersion/src/gpVersion_defs.h#1 $
 * $Change: 187624 $
...
gpVersion_VersionStatusResult_t Version_NegotiateModuleVersion(UInt8 moduleId, UInt8 nrOfClientVersions, gpVersion_ReleaseInfo_t* clientVersions, gpVersion_ReleaseInfo_t* serverInfo);
